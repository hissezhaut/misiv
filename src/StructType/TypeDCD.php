...
/**
 * This class stands for TypeDCD StructType
 * @subpackage Structs
 */
class TypeDCD extends AbstractStructBase
{
    /**
     * The ID
    ...
    public $Reponse;
    /**
     * Constructor method for TypeDCD
     * @uses TypeDCD::setID()
     * @uses TypeDCD::setTypeDemarche()
     * @uses TypeDCD::setDateCession()
     * @uses TypeDCD::setDateDemarche()
     * @uses TypeDCD::setTitulaire()
     * @uses TypeDCD::setAcquereur()
     * @uses TypeDCD::setVehicule()
     * @uses TypeDCD::setReponse()
     * @param int $iD
