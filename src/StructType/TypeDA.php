...
/**
 * This class stands for TypeDA StructType
 * @subpackage Structs
 */
class TypeDA extends AbstractStructBase
{
    /**
     * The ID
    ...
    public $Reponse;
    /**
     * Constructor method for TypeDA
     * @uses TypeDA::setID()
     * @uses TypeDA::setTypeDemarche()
     * @uses TypeDA::setDateAchat()
     * @uses TypeDA::setDateDemarche()
     * @uses TypeDA::setTitulaire()
     * @uses TypeDA::setAcquereur()
     * @uses TypeDA::setVehicule()
     * @uses TypeDA::setReponse()
     * @param int $iD
     ...
     */
    public function __construct($iD = null, $typeDemarche = null, $dateAchat = null, $dateDemarche = null, \Misiv\StructType\Titulaire $titulaire = null, \Misiv\StructType\Acquereur $acquereur = null, \Misiv\StructType\Vehicule $vehicule = null, \Misiv\StructType\Reponse $reponse = null)
    {
        $this
            ->setID($iD)
