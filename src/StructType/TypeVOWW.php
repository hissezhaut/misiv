...
/**
 * This class stands for TypeVOWW StructType
 * @subpackage Structs
 */
class TypeVOWW extends AbstractStructBase
{
    /**
     * The ID
    ...
    public $Reponse;
    /**
     * Constructor method for TypeVOWW
     * @uses TypeVOWW::setID()
     * @uses TypeVOWW::setTypeDemarche()
     * @uses TypeVOWW::setAcquereur()
     * @uses TypeVOWW::setVehicule()
     * @uses TypeVOWW::setPaiementCBClient()
     * @uses TypeVOWW::setNumPortable()
     * @uses TypeVOWW::setEmissionBO()
     * @uses TypeVOWW::setDateDemarche()
     * @uses TypeVOWW::setNbCotitulaires()
     * @uses TypeVOWW::setCotitulaires()
     * @uses TypeVOWW::setCarrossier()
     * @uses TypeVOWW::setReponse()
     * @param int $iD
