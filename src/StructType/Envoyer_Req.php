...
/**
 * This class stands for Envoyer_Req StructType
 * @subpackage Structs
 */
class Envoyer_Req extends AbstractStructBase
{
    /**
     * The Identification
    ...
    public $Lot;
    /**
     * Constructor method for Envoyer_Req
     * @uses Envoyer_Req::setIdentification()
     * @uses Envoyer_Req::setLot()
     ...
     * @param \Misiv\StructType\TypeIdentification $identification
     * @return \Misiv\StructType\Envoyer_Req
     */
