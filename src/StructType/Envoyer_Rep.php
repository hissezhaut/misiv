...
/**
 * This class stands for Envoyer_Rep StructType
 * @subpackage Structs
 */
class Envoyer_Rep extends AbstractStructBase
{
    /**
     * The Erreur
    ...
    public $Code;
    /**
     * Constructor method for Envoyer_Rep
     * @uses Envoyer_Rep::setErreur()
     * @uses Envoyer_Rep::setLot()
     * @uses Envoyer_Rep::setCode()
     * @param string $erreur
