...
/**
 * This class stands for TypeDSV StructType
 * @subpackage Structs
 */
class TypeDSV extends AbstractStructBase
{
    /**
     * The ID
    ...
    public $Reponse;
    /**
     * Constructor method for TypeDSV
     * @uses TypeDSV::setID()
     * @uses TypeDSV::setTypeDemarche()
     * @uses TypeDSV::setDateDemarche()
     * @uses TypeDSV::setTitulaire()
     * @uses TypeDSV::setVehicule()
     * @uses TypeDSV::setReponse()
     * @param int $iD
     ...
     */
    public function __construct($iD = null, $typeDemarche = null, $dateDemarche = null, \Misiv\StructType\Titulaire $titulaire = null, \Misiv\StructType\Vehicule $vehicule = null, \Misiv\StructType\Reponse $reponse = null)
    {
        $this
            ->setID($iD)
