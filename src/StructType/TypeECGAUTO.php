...
/**
 * This class stands for TypeECGAUTO StructType
 * @subpackage Structs
 */
class TypeECGAUTO extends AbstractStructBase
{
    /**
     * The ID
    ...
    public $Reponse;
    /**
     * Constructor method for TypeECGAUTO
     * @uses TypeECGAUTO::setID()
     * @uses TypeECGAUTO::setTypeDemarche()
     * @uses TypeECGAUTO::setDateDemarche()
     * @uses TypeECGAUTO::setVehicule()
     * @uses TypeECGAUTO::setReponse()
     * @param int $iD
     ...
     */
    public function __construct($iD = null, $typeDemarche = null, $dateDemarche = null, \Misiv\StructType\Vehicule $vehicule = null, \Misiv\StructType\Reponse $reponse = null)
    {
        $this
            ->setID($iD)
